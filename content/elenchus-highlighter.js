const highlightColor = "rgb(0, 255, 0)";
...
class ElenchusHighlighter extends HTMLElement {
    get markerPosition() {
    ...
    render() {
      ...
      this.shadowRoot
        .getElementById("elenchusHighlighter")
  ...
  window.customElements.define("elenchus-highlighter", ElenchusHighlighter);